...
<head>
<title>Key-Aggregate Proxy Re-Encryption with Dynamic Condition
	Generation Using Multilinear Map</title>
			...
			<div id="logo">
				<div id="logo_text">
					<br /> <br /> <font size="5"><a href="index.html"><span
							class="logo_colour">Key-Aggregate Proxy Re-Encryption with Dynamic Condition Generation Using Multilinear Map </span></a></font>
