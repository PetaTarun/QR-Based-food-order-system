...
<%@page import="cloudme.FileDownload"%>
...
<head>
<title>Key-Aggregate Proxy Re-Encryption with Dynamic Condition Generation Using Multilinear Map</title>
			...
			<div id="logo">
				<div id="logo_text">
					<br /> <br /> <font size="5"><a href="index.html"><span
							class="logo_colour"> Key-Aggregate Proxy Re-Encryption with Dynamic Condition Generation Using Multilinear Map</a></font>
				</div>
			</div>
			<div id="menubar">
				<ul id="menu">
						...
						<%
							...
							if (!isHavingAccess) {
								...
								if (FileDownload.fileDownload(path + filename)) {
									...
									FileOutputStream fos = new FileOutputStream(path+"searchdecrypted_"+filename);
									...
									String viewData = new String(Files.readAllBytes(Paths.get(path+"searchdecrypted_"+filename)));
